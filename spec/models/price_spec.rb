...
RSpec.describe Price, type: :model do
  describe '#valid?' do
    it 'must have a buffet_id' do
      ...
      price = Price.new(event_id: nil, base_price: 1500, additional_person: 20, extra_hour: 500,
    ...
    it 'must have a base_price' do
      ...
      event = Event.create!(buffet_id: buffet.id, name: 'Casamento', description: 'Buffets para casamentos', min_qtd: 50, max_qtd:1000,
                        duration: 240, menu: 'Frutos do Mar', drinks: true, decoration: true, valet: true)
      price = Price.new(event_id: event.id, base_price: nil, additional_person: 20, extra_hour: 500,
                        sp_base_price: 2500, sp_additional_person: 30, sp_extra_hour: 30)
    ...
    it 'must have a additional_person' do
      ...
      event = Event.create!(buffet_id: buffet.id, name: 'Casamento', description: 'Buffets para casamentos', min_qtd: 50, max_qtd:1000,
                        duration: 240, menu: 'Frutos do Mar', drinks: true, decoration: true, valet: true)
      price = Price.new(event_id: event.id, base_price: 2000, additional_person: nil, extra_hour: 500,
                        sp_base_price: 2500, sp_additional_person: 30, sp_extra_hour: 30)
    ...
    it 'must have a extra_hour' do
      ...
      event = Event.create!(buffet_id: buffet.id, name: 'Casamento', description: 'Buffets para casamentos', min_qtd: 50, max_qtd:1000,
                        duration: 240, menu: 'Frutos do Mar', drinks: true, decoration: true, valet: true)
      price = Price.new(event_id: event.id, base_price: 2000, additional_person: 20, extra_hour: nil,
                        sp_base_price: 2500, sp_additional_person: 30, sp_extra_hour: 30)
    ...
    it 'must have a sp_base_price' do
      ...
      event = Event.create!(buffet_id: buffet.id, name: 'Casamento', description: 'Buffets para casamentos', min_qtd: 50, max_qtd:1000,
                        duration: 240, menu: 'Frutos do Mar', drinks: true, decoration: true, valet: true)
      price = Price.new(event_id: event.id, base_price: 2000, additional_person: 20, extra_hour: 500,
