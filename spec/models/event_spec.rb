...
RSpec.describe Event, type: :model do
  describe '#valid?' do
    it 'must have a buffet_id' do
      ...
      event = Event.new(buffet_id: nil, name: '',
    ...
    it 'must have a name' do
      buffet = Buffet.create!(name: 'Vini Gourmet', corporate_name: 'Vinícius Gourmet alimentos', 
        ...
        payment_method: 'Pix, Débito, Crédito, Dinheiro',
        description: 'O melhor serviço de buffet do centro de Pelotas')
      event = Event.new(buffet_id: buffet.id, name: '',
        description: 'Buffets para casamentos',
        min_qtd: 50, max_qtd:1000, duration: 240, menu: 'Frutos do Mar',
        drinks: true, decoration: true, valet: true)
    ...
    it 'must have a description' do
      buffet = Buffet.create!(name: 'Vini Gourmet', corporate_name: 'Vinícius Gourmet alimentos', 
        ...
        payment_method: 'Pix, Débito, Crédito, Dinheiro',
        description: 'O melhor serviço de buffet do centro de Pelotas')
      event = Event.new(buffet_id: buffet.id, name: 'Casamento',
        description: '',
        min_qtd: 50, max_qtd:1000, duration: 240, menu: 'Frutos do Mar',
        drinks: true, decoration: true, valet: true)
    ...
    it 'must have a minimum capacity' do
      ...
      event = Event.new(buffet_id: buffet.id, name: 'Casamento',
        description: 'Buffets para casamentos',
        min_qtd: nil, max_qtd:1000, duration: 240, menu: 'Frutos do Mar',
        drinks: true, decoration: true, valet: true)
    ...
    it 'must have a maximum capacity' do
      ...
      event = Event.new(buffet_id: buffet.id, name: 'Casamento',
        description: 'Buffets para casamentos',
        min_qtd: 50, max_qtd: nil, duration: 240, menu: 'Frutos do Mar',
        drinks: true, decoration: true, valet: true)
    ...
    it 'must have a duration' do
      ...
      event = Event.new(buffet_id: buffet.id, name: 'Casamento',
        description: 'Buffets para casamentos',
        min_qtd: 50, max_qtd:1000, duration: nil, menu: 'Frutos do Mar',
        drinks: true, decoration: true, valet: true)
    ...
    it 'must have a menu' do
      ...
      event = Event.new(buffet_id: buffet.id, name: 'Casamento',
        description: 'Buffets para casamentos',
        min_qtd: 50, max_qtd:1000, duration: 240, menu: '',
        drinks: true, decoration: true, valet: true)
