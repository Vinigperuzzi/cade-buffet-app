...
describe 'User access his own buffet page to create a event' do
  ...
  it 'and see more than one' do
    ...
    event1 = Event.create!(name: 'Casamento',
      ...
      buffet_id: buffet.id)
    event2 = Event.create!(name: 'Evento Corporativo',
      description: 'Buffet com estilo mais profissional para eventos de empresa',
      min_qtd: 40, max_qtd: 100, duration: 360, menu: 'Canapés',
      buffet_id: buffet.id)
