...
describe 'Guest visit home page' do
  ...
  it 'and search for a buffet by name' do
    ...
    event2 = Event.create!(name: 'Formatura',
      ...
      min_qtd: 20, max_qtd: 40, duration: 250, menu: 'Frutos do Mar',
      buffet_id: buffet1.id)
    event3 = Event.create!(name: 'Casamento',
      description: 'Serviço de mesa completo para casamentos',
      min_qtd: 20, max_qtd: 40, duration: 250, menu: 'Frutos do Mar',
      buffet_id: buffet2.id)
    event4 = Event.create!(name: 'Aniversário',
      description: 'Serviço de mesa completo para aniversários',
      min_qtd: 20, max_qtd: 40, duration: 250, menu: 'Frutos do Mar',
      buffet_id: buffet2.id)
    event5 = Event.create!(name: 'Chá Revelação',
      description: 'Serviço de mesa completo para casamentos',
      min_qtd: 20, max_qtd: 40, duration: 250, menu: 'Frutos do Mar',
      buffet_id: buffet3.id)
    event6 = Event.create!(name: 'Eventos Corporativos',
      description: 'Serviço de mesa completo para casamentos',
      min_qtd: 20, max_qtd: 40, duration: 250, menu: 'Frutos do Mar',
      buffet_id: buffet3.id)
