...
describe 'Customer access chat' do
  it "and can see chat button" do
    ...
    order = Order.create!(buffet_id: buffet.id, event_id: event.id,
      ...
      address: '', order_status: :confirmed, final_price: 11000, extra_tax: 1000, discount: 500,
      customer_id: customer.id, out_doors: false)
  ...
  it "and access chat page for only it's own order's chat" do
    ...
    order2 = Order.create!(buffet_id: buffet.id, event_id: event.id,
      ...
      address: '', order_status: :waiting, final_price: 11000, extra_tax: 0, discount: 0,
      customer_id: customer2.id, out_doors: false)
  ...
  it "and can see messages send by customer and answer" do
    ...
    order = Order.create!(buffet_id: buffet.id, event_id: event.id,
      ...
      address: '', order_status: :waiting, final_price: 11000, extra_tax: 1000,
      discount: 500, customer_id: customer.id, out_doors: false)
    message = Message.create!(order_id: order.id, sender: :user, customer_read: false,
      user_read: false, message_text: 'Olá, tudo bem?')
  ...
  it "and can see messages marked as not visualized" do
    ...
    message = Message.create!(order_id: order.id, sender: :customer,
      customer_read: true, user_read: false, message_text: 'Olá, tudo bem?')
