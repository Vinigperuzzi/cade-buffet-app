...
describe 'A person access home page' do
  ...
  it 'and are not authenticated (but force http route)' do
    ...
    price = Price.create!(base_price: 5000, sp_base_price:6000,
      sp_additional_person:500, additional_person:20,
    ...
    order = Order.create!(buffet_id: buffet.id, event_id: event.id,
      ...
      address: '', order_status: :waiting,
      final_price: nil, extra_tax: nil, discount: nil,
  ...
  it "and can't force confirm an order from url unauthenticated" do
    ...
    order = Order.create!(buffet_id: buffet.id, event_id: event.id,
      ...
      event_details: 'Esse evento deve possuir toda a temática com corações rosa',
      address: '', order_status: :evaluated, final_price: "16000", extra_tax: nil,
